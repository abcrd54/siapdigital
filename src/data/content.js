      ...
      items: [
        ...
        },
        {
          ...
          features: [
            ...
            "SEO dasar",
            "SEO beberapa halaman",
            "Copywriting ringan: sesuai kebutuhan",
            "Testimoni & FAQ: sesuai kebutuhan",
            "Katalog produk: bisa",
            "Keranjang belanja: bisa",
            "Checkout: bisa",
            "Midtrans: bisa",
            "Dashboard admin: custom",
            "Login user/admin: ya",
            "Export/import data: ya",
            "Laporan: ya",
            "Revisi: sesuai scope",
          ],
        },
      ...
      items: [
        ...
        },
        {
          ...
          features: [
            ...
            "Basic SEO",
            "Multi-page SEO",
            "Light copywriting: based on needs",
            "Testimonials & FAQ: based on needs",
            "Product catalog: available",
            "Shopping cart: available",
            "Checkout: available",
            "Midtrans: available",
            "Admin dashboard: custom",
            "User/admin login: yes",
