...
export const siteCopy = {
  id: {
    ...
    packages: {
      ...
      body: "Fitur utama tiap paket dibuat jelas supaya lebih mudah dibandingkan.",
      ...
      items: [
        {
          ...
          features: [
            ...
            "Tampilan: template modern",
            "HP: nyaman dibuka di mobile",
            "SEO: belum termasuk",
            "WhatsApp: tombol chat langsung",
            "Revisi: 1 kali",
          ],
        },
        {
          ...
          features: [
            "Jumlah halaman: sampai 5 halaman",
            "Tampilan: desain lebih fleksibel",
            "HP: nyaman dibuka di mobile",
            "SEO: dasar",
            "WhatsApp: balasan otomatis sederhana",
            "Revisi: 3 kali",
          ],
          featured: true,
        },
        {
          ...
          features: [
            "Jumlah halaman: sampai 10 halaman",
            "Tampilan: desain lebih premium",
            "HP: nyaman dibuka di mobile",
            "SEO: dasar lengkap",
            "WhatsApp: menu chat sederhana",
            "Revisi: 5 kali",
          ],
        },
        {
          ...
          features: [
            "Jumlah halaman: sampai 10 halaman + toko online",
            "Tampilan: desain premium + toko online",
            "HP: nyaman dibuka di mobile",
            "SEO: dasar lengkap",
            "WhatsApp: menu chat sederhana",
            "Pembayaran: Midtrans",
        ...
        },
        {
          ...
          features: [
            ...
            "Tampilan: sistem custom",
            "HP: nyaman dibuka di mobile",
            "SEO: dasar lengkap",
            "WhatsApp: bisa ditambahkan",
            "Pembayaran: bisa ditambahkan",
  ...
  en: {
    ...
    packages: {
      ...
      body: "Each package shows its main features clearly for easier comparison.",
      ...
      items: [
        ...
        },
        {
          ...
          features: [
            "Pages: up to 5 pages",
            "Design: more flexible design",
            "Mobile: easy to open on phones",
            "SEO: basic",
            "WhatsApp: simple auto reply",
            "Revisions: 3 rounds",
          ],
          featured: true,
        },
        ...
        },
        {
          ...
          features: [
            "Pages: up to 10 pages + online store",
            "Design: premium + online store",
            "Mobile: easy to open on phones",
            "SEO: full basic",
            "WhatsApp: simple chat menu",
            "Payment: Midtrans",
