      ...
      items: [
        ...
        },
        {
          ...
          features: [
            ...
            "Konten: copywriting, testimoni, FAQ",
            "Revisi: 5x",
          ],
        },
        {
          ...
          features: [
            ...
            "SEO: beberapa halaman",
            "Konten: copywriting, testimoni, FAQ",
            "Toko online: katalog, cart, checkout",
            "Payment Gateway: Midtrans",
            "Sistem: dashboard sederhana, login opsional",
            "Revisi: 5x",
          ],
        },
        {
          ...
          features: [
            ...
            "Sistem: dashboard, login, custom flow",
            "Integrasi: API",
            "Notifikasi: email, WhatsApp",
            "Data: export/import, laporan",
      ...
      items: [
        ...
        },
        {
          ...
          features: [
            ...
            "Mobile: yes",
            "SEO: multi-page",
            "Content: copywriting, testimonials, FAQ",
            "Revisions: 5x",
          ],
        },
        {
          ...
          features: [
            ...
            "Payment Gateway: Midtrans",
            "System: simple dashboard, optional login",
            "Revisions: 5x",
          ],
        },
        {
          ...
          features: [
            ...
            "Online store: catalog, cart, checkout",
            "Payment Gateway: Midtrans, Xendit",
            "System: dashboard, login, custom flow",
            "Integration: API",
            "Notification: email, WhatsApp",
            "Data: export/import, reports",
